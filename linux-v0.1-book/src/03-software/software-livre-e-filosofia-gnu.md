...
Em vez de usar o direito autoral para instruir e restringir o uso e a modificação, o copyleft usa a lei para garantir que ninguém possa remover essas liberdades. Sob uma licença com copyleft, qualquer pessoa é livre para modificar e redistribuir o código, desde que a versão modificada seja distribuída sob as mesmas condições de liberdade. Isso impede que uma empresa pegue um código público, faça melhorias e o transforme em um produto fechado e proprietário.
...
O kernel gerencia o processador, a memória e os discos; as ferramentas GNU fornecem a interface, os utilitários e o ambiente para o usuário operar o sistema. Um não funciona como um sistema completo sem o outro.
