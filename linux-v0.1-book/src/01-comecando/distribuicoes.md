...
A [Debian](https://www.debian.org/) nasceu em 1993 e foi construída com um princípio muito claro: *software livre*, estabilidade e governança comunitária. Ela criou o formato de pacotes `.deb` e o gerenciador `apt`, que se tornaram padrão em boa parte do mundo Linux.
...
O [Slackware](http://www.slackware.com/), lançado em 1993, é a distribuição ativa mais antiga. Sem gerenciador de dependências, sem assistentes o *purismo total*.
